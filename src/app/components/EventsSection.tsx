  ...
  return (
    <section id="events" className="relative overflow-hidden px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <motion.div
        ...
        className="group relative mx-auto max-w-7xl overflow-hidden rounded-2xl border border-[#B88A3D]/50 bg-[#F2ECE1]/40 hover:bg-[#F2ECE1]/55 p-6 sm:p-10 lg:p-12 shadow-[0_15px_45px_rgba(75,50,37,0.15),inset_0_0_40px_rgba(184,138,61,0.08)] hover:border-[#B8322C] hover:shadow-[0_20px_60px_rgba(184,50,44,0.2)] transition-all duration-500 backdrop-blur-md transform-gpu"
      >
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(184,138,61,0.18)_0%,transparent_65%)] pointer-events-none z-0" />
        ...
        {/* Grand Kanji Watermark (祭 - Festival & 闘 - Combat) */}
        ...
        <div className="absolute top-5 right-6 flex flex-col items-center justify-center size-9 sm:size-10 rounded border-2 border-[#B8322C] bg-[#B8322C]/10 text-[#B8322C] font-serif font-bold text-[12px] tracking-tighter select-none rotate-6 shadow-[0_0_12px_rgba(184,50,44,0.25)] pointer-events-none z-20">
          ...
          <span className="text-[5px] font-mono tracking-widest text-[#B8322C]/80 uppercase">EVENT</span>
        </div>
        ...
        <div className="relative z-10 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-14">
          <div className="max-w-2xl">
            ...
            <p className="mt-3.5 max-w-xl text-sm sm:text-base leading-relaxed text-[#38332C] font-sans font-medium">
              Browse every technical battleground, hackathon, robotics duel, gaming arena, and cultural night in one focused mission board.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-xs font-accent uppercase tracking-[0.2em]">
              <span className="inline-flex items-center gap-2 border border-[#B8322C]/30 bg-[#EAE1D2]/80 px-3.5 py-2 rounded-lg shadow-sm text-[#1D1B18] font-bold">
                <Trophy className="size-3.5 text-[#B8322C]" />
                <span>{events.length} missions</span>
              </span>
              <span className="inline-flex items-center gap-2 border border-[#B88A3D]/40 bg-[#EAE1D2]/80 px-3.5 py-2 rounded-lg shadow-sm text-[#1D1B18]">
                <span className="text-[#B88A3D] font-bold">全種目</span>
                <span className="text-[#5A5043] font-semibold">Sort & filter</span>
              </span>
            </div>
          </div>
          ...
          >
            ...
            <span className="relative z-10 font-bold tracking-[0.25em]">Open event board</span>
