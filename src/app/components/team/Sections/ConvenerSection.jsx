...
export default function ConvenerSection({ onOpenConvener, setHoveredTorii }) {
  ...
  return (
    <section className="vertical-team-section w-full py-12 flex flex-col items-center justify-center [perspective:1200px]" id="convener-section">
      <motion.div
        ref={cardRef}
      ...
      >
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 font-accent text-[11px] sm:text-xs uppercase tracking-[0.25em] text-[#B8322C] font-semibold bg-[#B8322C]/10 border border-[#B8322C]/30 px-4 py-1.5 rounded-full shadow-sm">
            <Crown className="size-3.5 text-[#B8322C]" />
          ...
          <p className="text-xs sm:text-sm lg:text-base leading-relaxed text-[#1D1B18]/80 font-sans font-medium max-w-[280px] sm:max-w-[320px] mx-auto px-4 mb-2">
            The visionary mentor guiding Tech Kurukshetra through innovation, excellence, and strategic direction.
          </p>
