...
export default function ConvenerSection({ onOpenConvener, setHoveredTorii }) {
  ...
  return (
    <section className="vertical-team-section w-full py-2 sm:py-8 flex flex-col items-center justify-center [perspective:1200px]" id="convener-section">
      <motion.div
        ref={cardRef}
      ...
      >
        ...
        <svg className="absolute inset-[-6%] size-[112%] pointer-events-none z-10 overflow-visible" viewBox="0 0 200 200" style={{ animation: 'spin 40s linear infinite' }}>
          <defs>
            ...
            <linearGradient id="ensoGradConvener" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <g filter="url(#rough-ink-convener)">
        ...
        >
          ...
          <div className="inline-flex items-center gap-1.5 sm:gap-2 font-accent text-[10px] sm:text-xs uppercase tracking-[0.2em] sm:tracking-[0.25em] text-[#B8322C] font-semibold bg-[#B8322C]/10 border border-[#B8322C]/30 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full shadow-sm">
            <Crown className="size-3 sm:size-3.5 text-[#B8322C]" />
            <span>指導者 • Leadership</span>
          </div>
          ...
          <h2 className="font-display text-2xl sm:text-4xl lg:text-5xl text-[#1D1B18] uppercase tracking-wide leading-tight my-1 sm:my-3 drop-shadow-sm">
            MEET THE <br />
            <span className="text-[#B8322C]">CONVENER</span>
          </h2>
          ...
          <p className="text-[11px] sm:text-sm lg:text-base leading-snug sm:leading-relaxed text-[#1D1B18]/80 font-sans font-medium max-w-[220px] sm:max-w-[320px] mx-auto px-2 mb-1 sm:mb-2">
            The visionary mentor guiding Tech Kurukshetra through innovation and excellence.
          </p>
          ...
          >
            ...
            <span className="relative z-10 transition-colors group-hover/btn:text-white whitespace-nowrap">VIEW CONVENER</span>
