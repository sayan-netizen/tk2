...
export default function VolunteersSection({ onOpenVolunteers, setHoveredTorii }) {
  ...
  return (
    <section className="vertical-team-section w-full py-12 flex flex-col items-center justify-center [perspective:1200px]" id="volunteers-section">
      <motion.div
        ref={cardRef}
      ...
      >
        ...
        <svg className="absolute inset-[-6%] size-[112%] pointer-events-none z-10 overflow-visible" viewBox="0 0 200 200" style={{ animation: 'spin 40s linear infinite' }}>
          ...
          <g filter="url(#rough-ink-volunteers)">
            <path d="M 94 10 C 146 8 190 48 190 100 C 190 152 148 192 100 190 C 50 188 8 148 10 98 C 12 50 50 12 86 10" fill="none" stroke="url(#ensoGradVolunteers)" strokeWidth="12" strokeLinecap="round" strokeDasharray="560 40" className="opacity-95" />
        ...
        <div className="absolute top-7 right-8 sm:top-9 sm:right-11 flex flex-col items-center justify-center size-8 sm:size-10 rounded border-2 border-[#B8322C] bg-[#B8322C]/10 text-[#B8322C] font-serif font-bold text-xs sm:text-sm tracking-tighter select-none rotate-6 shadow-[0_0_12px_rgba(184,50,44,0.25)] pointer-events-none z-20" style={{ transform: "translateZ(30px)" }}>
          <span className="leading-none">奉</span>
        ...
        >
          <div className="inline-flex items-center gap-2 font-accent text-[11px] sm:text-xs uppercase tracking-[0.25em] text-[#B8322C] font-semibold bg-[#B8322C]/10 border border-[#B8322C]/30 px-4 py-1.5 rounded-full shadow-sm">
            <HeartHandshake className="size-3.5 text-[#B8322C]" />
            <span>奉仕部隊 • Volunteer Squad</span>
          </div>
          ...
          <p className="text-xs sm:text-sm lg:text-base leading-relaxed text-[#1D1B18]/80 font-sans font-medium max-w-[280px] sm:max-w-[320px] mx-auto px-4 mb-2">
            The dedicated student volunteers executing operations with passion, energy, and unwavering commitment.
          </p>
