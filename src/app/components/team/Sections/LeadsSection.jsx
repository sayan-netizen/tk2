...
export default function LeadsSection({ onOpenChambers, setHoveredTorii }) {
  ...
  return (
    <section className="vertical-team-section w-full py-12 flex flex-col items-center justify-center [perspective:1200px]" id="leads-section">
      <motion.div
        ref={cardRef}
      ...
      >
        ...
        <div className="absolute top-7 right-8 sm:top-9 sm:right-11 flex flex-col items-center justify-center size-8 sm:size-10 rounded border-2 border-[#B8322C] bg-[#B8322C]/10 text-[#B8322C] font-serif font-bold text-xs sm:text-sm tracking-tighter select-none rotate-6 shadow-[0_0_12px_rgba(184,50,44,0.25)] pointer-events-none z-20" style={{ transform: "translateZ(30px)" }}>
          <span className="leading-none">義</span>
        ...
        >
          ...
          >
            ...
            <span className="relative z-10 transition-colors group-hover/btn:text-white whitespace-nowrap">ENTER THE CHAMBERS</span>
