...
export default function FacultySection({ onOpenFaculty, setHoveredTorii }) {
  ...
  return (
    <section className="vertical-team-section w-full py-2 sm:py-8 flex flex-col items-center justify-center [perspective:1200px]" id="faculty-section">
      <motion.div
        ref={cardRef}
      ...
      >
        ...
        <svg className="absolute inset-[-6%] size-[112%] pointer-events-none z-10 overflow-visible" viewBox="0 0 200 200" style={{ animation: 'spin 40s linear infinite' }}>
          <defs>
            ...
            <filter id="rough-ink-faculty" x="-20%" y="-20%" width="140%" height="140%">
              <feTurbulence type="fractalNoise" baseFrequency="0.12" numOctaves="4" result="noise" />
              <feDisplacementMap in="SourceGraphic" in2="noise" scale="3.5" xChannelSelector="R" yChannelSelector="G" />
            </filter>
            
            <linearGradient id="ensoGradFaculty" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <g filter="url(#rough-ink-faculty)">
        ...
        <div className="absolute top-5 right-6 sm:top-9 sm:right-11 flex flex-col items-center justify-center size-7 sm:size-10 rounded border-2 border-[#B8322C] bg-[#B8322C]/10 text-[#B8322C] font-serif font-bold text-[10px] sm:text-sm tracking-tighter select-none rotate-6 shadow-[0_0_12px_rgba(184,50,44,0.25)] pointer-events-none z-20" style={{ transform: "translateZ(30px)" }}>
          <span className="leading-none">導</span>
        ...
        >
          ...
          <div className="inline-flex items-center gap-1.5 sm:gap-2 font-accent text-[10px] sm:text-xs uppercase tracking-[0.2em] sm:tracking-[0.25em] text-[#B8322C] font-semibold bg-[#B8322C]/10 border border-[#B8322C]/30 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full shadow-sm">
            <GraduationCap className="size-3 sm:size-3.5 text-[#B8322C]" />
            <span>顧問教員 • Faculty Guidance</span>
          </div>
          ...
          <h2 className="font-display text-2xl sm:text-4xl lg:text-5xl text-[#1D1B18] uppercase tracking-wide leading-tight my-1 sm:my-3 drop-shadow-sm">
            MEET THE <br />
            <span className="text-[#B8322C]">FACULTY</span>
          </h2>
          ...
          <p className="text-[11px] sm:text-sm lg:text-base leading-snug sm:leading-relaxed text-[#1D1B18]/80 font-sans font-medium max-w-[220px] sm:max-w-[320px] mx-auto px-2 mb-1 sm:mb-2">
            The esteemed faculty mentors guiding Tech Kurukshetra with direction and leadership.
          </p>
