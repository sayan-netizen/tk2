  ...
  return (
    <section className="relative overflow-hidden px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
      ...
      >
        ...
        <div className="absolute -right-3 -top-20 select-none font-display text-[18rem] leading-none text-[#d51e1e]/10 sm:right-8 sm:text-[23rem]">
          戦
        </div>
        ...
        <div className="relative grid gap-8 px-6 py-9 sm:px-10 sm:py-12 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-14 lg:px-14">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="group inline-flex w-fit items-center gap-4 border border-[#b91919] bg-black/5 font-accent text-[10px] uppercase tracking-[0.2em] text-[#f1eeee] shadow-[0_0_14px_rgba(185,25,25,0.24)] hover:bg-[#b91919]/10 px-5 py-4 transition-all sm:px-6"
          >
            ENTER THE CHAMBERS
